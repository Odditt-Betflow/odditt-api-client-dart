...
class AffiliatesApi {
  ...
  const AffiliatesApi(this._dio, this._serializers);
  ...
  Future<Response<JsonObject>> v1AffiliatesEventPositionPost({ 
    required V1AffiliatesEventPositionPostRequest v1AffiliatesEventPositionPostRequest,
    ...
    final _path = r'/v1/affiliates/event-position';
    ...
    try {
      const _type = FullType(V1AffiliatesEventPositionPostRequest);
      _bodyData = _serializers.serialize(v1AffiliatesEventPositionPostRequest, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [JsonObject] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> v1AffiliatesParlayPost({ 
    required V1AffiliatesParlayPostRequest v1AffiliatesParlayPostRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/v1/affiliates/parlay';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(V1AffiliatesParlayPostRequest);
      _bodyData = _serializers.serialize(v1AffiliatesParlayPostRequest, specifiedType: _type);
