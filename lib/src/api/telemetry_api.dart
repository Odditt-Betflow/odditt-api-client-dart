...
class TelemetryApi {
  ...
  Future<Response<void>> v1AffiliatesEventsPost({ 
    required V1AffiliatesEventsPostRequest v1AffiliatesEventsPostRequest,
    ...
    final _path = r'/v1/affiliates/events';
    ...
    try {
      const _type = FullType(V1AffiliatesEventsPostRequest);
      _bodyData = _serializers.serialize(v1AffiliatesEventsPostRequest, specifiedType: _type);
