...
class ReportingApi {
  ...
  Future<Response<JsonObject>> v1AffiliatesLinksClicksGet({ 
    required Date startDate,
    required Date endDate,
    int? operatorId,
    String? countryCode,
    String? subnationalRegionCode,
    String? offerCampaign,
    String? offerLabel,
    ...
    final _path = r'/v1/affiliates/links/clicks';
    ...
    final _queryParameters = <String, dynamic>{
      ...
      if (subnationalRegionCode != null) r'subnational_region_code': encodeQueryParameter(_serializers, subnationalRegionCode, const FullType(String)),
      if (offerCampaign != null) r'offer_campaign': encodeQueryParameter(_serializers, offerCampaign, const FullType(String)),
      if (offerLabel != null) r'offer_label': encodeQueryParameter(_serializers, offerLabel, const FullType(String)),
    };
  ...
  /// Returns a [Future] containing a [Response] with a [JsonObject] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> v1AffiliatesLinksInventorySummaryGet({ 
    ...
    final _path = r'/v1/affiliates/links/inventory-summary';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
